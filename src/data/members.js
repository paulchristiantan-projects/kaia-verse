export const members = [
  {
    ...
    emoji: "🐻",
    fandomName: "Jellies",
    img: "/assets/img/gallery/angela0.jpg",
...
Angela has mentioned that her handwriting is difficult to read. As a child, she and her twin sister, Charice, were commercial models and actresses known as the "Lumen Twins." They even appeared in *Inday Will Always Love You* as minions of Kim Rodriguez's character. Additionally, she was an active member of the student council during her school years.

Angela lives by the motto: *"Make every day your masterpiece."*`,
    socials: {
  ...
  },
  {
    ...
    emoji: "🍒",
    fandomName: "Cherries",
    img: "/assets/img/gallery/charice0.jpg",
...
Charice lives by the motto: *"Take the risk, or lose a chance."*`,
    socials: {
  ...
  },
  {
    ...
    emoji: "🐉",
    fandomName: "Dragons",
    img: "/assets/img/gallery/alexa0.jpg",
    modalId: "modal-alexa",
    ...
    zodiac: "Taurus",
    bio: `Alexa is from Las Piñas City and fondly refers to herself as Alexa Kyutie. She has a particular liking for the colors yellow and black and has a deep appreciation for animals, especially lions and dogs. When it comes to food, she enjoys pesto and fries, while coffee remains an essential part of her daily routine—she drinks it frequently and loves it dearly. She also finds comfort in rainy weather.
...
Alexa describes herself as a homebody and the cleanest member of her group. However, she dislikes having different types of food mixed on the same plate. She humorously claims that her special skill is converting oxygen to carbon dioxide—literally breathing. She believes she excels at sleeping, complimenting herself, and drinking coffee. Conversely, she admits she struggles with staying still, making decisions, and answering personal questions.

Her personal motto is: *"If life gives you lemons, squeeze them in people's eyes."*`,
    socials: {
  ...
  },
  {
    ...
    emoji: "🦊",
    fandomName: "Sopas",
    img: "/assets/img/gallery/sophia0.jpg",
...
In terms of entertainment, Sophia is a fan of movies such as Clueless, Breakfast at Tiffany's, and the Marvel Universe series. She enjoys reading books like It Ends With Us, What Light, and Love & Gelato. Her favorite TV show is Friends, and she admires solo artists Billie Eilish, Ariana Grande, and Taylor Swift, whom she considers her role model. Among music groups, she is a fan of Little Mix and One Direction, while in the K-pop industry, she looks up to Ryujin.

Dancing is both her passion and hobby, and she was previously a member of the VPEEZ dance crew, which competed internationally. Before joining ShowBT, she worked as one of the backup dancers in SB19's "WHAT" music video. She also enjoys playing Cooking City, and volleyball is her sport of choice.

Sophia's love for coffee is so strong that she can drink it all day and still fall asleep early. She has been wearing glasses since 4th grade, with her current eye prescription at -4.00. She first had braces until September 2021 and had them reinstalled in 2022. She believes her strengths lie in dancing, memorizing details, and singing high notes, while she admits to struggling with cooking, drawing, and drinking enough water.
...
Sophia lives by the motto: *"Work until you no longer have to introduce yourself."*`,
    socials: {
  ...
  },
  {
    ...
    emoji: "🍊",
    fandomName: "Charms",
    img: "/assets/img/gallery/charlotte0.jpg",
