    ...
    const members = [
        {
            ...
            bio: `<p class="member-info-text mt-4">
                    ...
                    <em>“Make every day your masterpiece.”</em>  
                    </p>`,
            socials: {
        ...
        },
        {
            ...
            bio: `<p class="member-info-text mt-4">
                  ...
                  <em>“Take the risk, or lose a chance.”</em>  
                   </p>`,
            socials: {
        ...
        },
        {
            ...
            bio: `<p class="member-info-text mt-4">
                    ...
                    <em>“If life gives you lemons, squeeze them in people’s eyes.”</em>  
                </p>`,
            socials: {
        ...
        },
        {
            ...
            bio: `<p class="member-info-text mt-4">
                ...
                <em>“Work until you no longer have to introduce yourself.”</em>  
            </p>`,
            socials: {
